 ...
 * @LastEditTime: 2019-08-26 12:28:34
 */
// 环境
// const env = true
...
const URL = env && isCloudEnv
    ? 'https://gateway-test.xbdq.com.cn'
    : 'http://192.168.198.124:10011'

// 文件服务
const UPLOAD = env && isCloudEnv
    ? 'https://file-test.xbdq.com.cn'
    : 'http://192.168.198.144:10081'
// 文件预览
const FILE_REVIEW = env && isCloudEnv
    ? 'https://file-test.xbdq.com.cn/file/download'
    : 'http://192.168.198.144:8888'
...
// 是否对接老系统 (SKU辅助信息)
const isConnectOldErp = true

// 是否公司环境
export const isCompanyEnv = false
/**
 * @description 免权接口定义
 */
const PATH = {
