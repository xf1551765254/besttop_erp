 ...
 * @LastEditTime: 2019-08-09 18:03:03
 */
// 环境
...
const URL = env && isCloudEnv
    ? 'https://erp-server-test.dongge.com'
    : 'http://192.168.198.190:10011'

// 文件服务
const UPLOAD = env && isCloudEnv
    ? 'https://file-server-test.dongge.com'
    : 'http://192.168.198.144:10081'
// 文件预览
const FILE_REVIEW = env && isCloudEnv
    ? 'https://file-server-test.dongge.com/review'
...
* @description 微信服务
*/
const WECHAT = 'https://erp-server-test.dongge.com'
