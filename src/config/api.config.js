 ...
 * @LastEditTime: 2019-08-28 18:11:16
 */
// 环境
const env = true
...
const PATH = {
    ...
    // 赋权接口
    ActionMenuFunctionFindAllMenu: '/api-action/action/menuFunction/findAllMenu',
    ActionMenuFunctionFindActionByMenu: '/api-action/action/menuFunction/findActionByMenu',
    ActionMenuFunctionFindAllApi: '/api-action/action/menuFunction/findAllApi',
    ActionMenuFunctionAddAction: '/api-action/action/menuFunction/addAction',
    ActionMenuFunctionFindSysList: '/api-action/action/menuFunction/findSysList',
    ActionMenuFunctionFindMenuList: '/api-action/action/menuFunction/findMenuList',
    ActionMenuFunctionAddButton: '/api-action/action/menuFunction/addButton',
    ActionMenuFunctionDeleteByCodes: '/api-action/action/menuFunction/deleteByCodes',
    ActionMenuFunctionUpdateMenu: '/api-action/action/menuFunction/updateMenu',
    ...
    GoodsInformationFindGoodsList: '/api-goods/goods/information/findGoodsList',
    /**
     *
     * 多语言自定义修改
     */
    ...
    /*  图表接口  */
    // 合同统计
    contractStatistics: '/api-purchase/analyze/queryProviderStatistics',
    // 打款统计
    remitStatistics: '/api-purchase/bill/appropriation/findStatistics',
    // 内调拨统计查询
    internalTransference: '/api-logistic/distribution/billAllot/census',
    // 订单统计查询
    orderStatistics: '/api-purchase/analyze/queryOrderStatistics',
    // 订单统计查询
    returnStatistics: '/api-purchase/analyze/queryWithdrawStatistics',
    /* 公告  */
    SysNoticeFindNotice: '/api-user/sys/notice/findNotice'
