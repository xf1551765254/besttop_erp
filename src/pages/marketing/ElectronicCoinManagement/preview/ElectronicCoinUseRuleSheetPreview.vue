 ...
 * @Company: BestTop
 * @Author: lin
 * @Date: 2019-07-25 16:51:56
 * @LastEditors: lin
 * @LastEditTime: 2019-07-26 18:33:54
 -->
<template>
  <div>
    <Preview
...
export default {
    ...
    data () {
        return {
            ...
            previewHeaders: [
                ...
                { key: 'coinStandardAmount', name: '达标金额' },
                { key: 'coinReachAmount', name: '满金额' },
                { key: 'coinUseAmount', name: '用金额' },
                { key: 'coinMaxAmount', name: '上限金额' },
                { key: 'note', name: '备注' }
            ],
            previewColumns: [
    ...
    methods: {
        ...
        detailsSumbit () {
            axios({
                path: 'CoinRuleQueryRuleDefineList',
                method: 'post',
                body: {
                    code: this.orderId
                }
                ...
                if (res.flag === 1) {
                    ...
                    if (detailData.status === 'schedule_coin_rule_define_status:1') {
                        this.previewTags = ['uncheck']
                    } else if (detailData.status === 'schedule_coin_rule_define_status:2') {
                        this.previewTags = ['check']
                    } else if (detailData.status === 'schedule_coin_rule_define_status:3') {
                        this.previewTags = ['effective']
                    } else if (detailData.status === 'schedule_coin_rule_define_status:4') {
                    ...
                    this.previewContent.headers = {
                        ...
                        coinStandardAmount: detailData.coinStandardAmount,
                        coinReachAmount: detailData.coinReachAmount,
                        coinUseAmount: detailData.coinUseAmount,
                        coinMaxAmount: detailData.coinMaxAmount,
