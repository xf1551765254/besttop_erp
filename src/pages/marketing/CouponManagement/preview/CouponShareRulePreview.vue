<!--
 * @Description: 促销券分摊规则预览
 * @Version: ^1.2.0
 * @Company: BestTop
 * @Author: lin
 * @Date: 2019-08-08 11:23:26
 * @LastEditors: lin
 * @LastEditTime: 2019-08-15 17:40:53
 -->
<template>
  <div>
    <Preview
        ...
        detailsSumbit () {
            axios({
                ...
                if (res.flag === 1) {
                    ...
                    if (detailData.status === 'schedule_coupon_share_define_status:1') {
                        this.previewTags = ['uncheck']
                    } else if (detailData.status === 'schedule_coupon_share_define_status:2') {
                        this.previewTags = ['check']
                    } else if (detailData.status === 'schedule_coupon_share_define_status:3') {
                        this.previewTags = ['effective']
                    } else if (detailData.status === 'schedule_coupon_share_define_status:4') {
