 ...
 * @Company: BestTop
 * @Author: lin
 * @Date: 2019-08-06 11:15:52
 * @LastEditors: lin
 * @LastEditTime: 2019-08-19 18:46:52
 -->
<template>
  <div>
    <!-- 工具栏 -->
    ...
    <a-modal
      ...
      <a-form :form="form">
        <a-row class="doc">
          <a-col :span="4">促销券类型</a-col>
          <a-col :span="20">
            <a-form-item>
              <a-input
                style="width:100%"
                placeholder="请输入促销券类型"
                v-decorator="$check('CouponDefinition.name',{initialValue:tableSingleData.name})"
              />
            </a-form-item>
          </a-col>
        </a-row>
          ...
          <a-col :span="20">
            <a-form-item>
              <a-textarea
                ...
                :rows="2"
                placeholder="请输入备注"
                v-decorator="$check('CouponDefinition.note',{initialValue:tableSingleData.note})"
              />
            </a-form-item>
          </a-col>
        </a-row>
...
export default {
    ...
    data () {
        return {
            ...
            moenuOPT: [
                { name: '编辑',
                    action: 'CouponDefinition.edit',
                    fc: this.addEdit
                },
                { name: '删除',
                    action: 'CouponDefinition.delete',
    ...
    mounted () {
        this.$nextTick(() => {
            this.tableCode = '9da836f910954039b875a63c8781946e:CouponDefinition'
            this.tableApiPath = 'ScheduleCouponTypeDefineQueryDefinePageList'
    ...
    methods: {
         ...
         */
        onSeach (e) {
            e.path = 'ScheduleCouponTypeDefineQueryDefinePageList'
        ...
        onSeachClick (e) {
            if (e === 'add') {
                ...
                this.$refs.newTable.exportFile('ScheduleCouponTypeDefineQueryDefinePageList')
            }
        },
        /**
         * @name: 更新表格
         ...
         */
        reLoadTableData () {
            this.$refs.newTable.setTableData(this.tableCode, { path: 'ScheduleCouponTypeDefineQueryDefinePageList' })
        },
        /**
         * @name: 表格的多选
         * @msg:
        ...
        deleteHandler (delEventData) {
            ...
            this.$confirm({
                ...
                onOk () {
                    axios({
                        path: 'ScheduleCouponTypeDefineBatchDelete', // 接口path名，必传
                        method: 'post',
                        body: {
                            ids: arr
                        }
        ...
        addEdit (addEditData) {
            ...
            if (addEditData === -1) {
                ...
                this.addEditModalTitle = '新增促销券'
                this.isAdd = true
            } else {
                this.addEditModalTitle = '编辑促销券'
                this.isAdd = false
        ...
        submitClick (e) {
            ...
            validateFields((err, values) => {
                if (!err) {
                    ...
                    axios({
                        path: 'ScheduleCouponTypeDefineAddScheduleCoupnTypeTypeDefine',
                        method: 'post',
                        body: values
                    }).then(res => {
