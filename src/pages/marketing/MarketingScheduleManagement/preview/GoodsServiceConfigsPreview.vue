 ...
 * @Company: BestTop
 * @Author: lin
 * @Date: 2019-07-29 14:34:34
 * @LastEditors: lin
 * @LastEditTime: 2019-08-19 17:48:02
 -->
<template>
  <div>
    <Preview
      ...
      <div slot="A" title="规则单商品详情" :isTable="true" :columns="previewColumns" :data="previewTableData"></div>
      <div
        slot="C"
        title="规则设置详情"
        :isTable="true"
...
export default {
    ...
    data () {
        return {
            ...
            previewHeaders: [
                ...
                { key: 'serviceEffectDate', name: '服务生效日期' },
                { key: 'serviceExpireDate', name: '服务失效日期' },
                { key: 'note', name: '备注' }
            ],
            previewColumns: [
            ...
            tableColumnsGift: [
                ...
                { title: '赠品数量', dataIndex: 'quantity', align: 'center', width: 150 },
                { title: '赠品上限数量', dataIndex: 'maxAmount', align: 'center', width: 150 },
                { title: '分摊金额（元）', dataIndex: 'rateAmount', align: 'center', width: 150 },
    ...
    methods: {
        findDetail (id) {
            axios({
                ...
                if (res.flag === 1) {
                    ...
                    this.detailDataGift = [...res.data.ruleDetailList]
                }
        ...
        detailsSumbit () {
            axios({
                path: 'ScheduleServiceQueryServiceList',
                method: 'post',
                body: {
                    code: this.orderId
                }
                ...
                if (res.flag === 1) {
                    ...
                    if (detailData.status === 'schedule_service_define_status:1') {
                        this.previewTags = ['uncheck']
                    } else if (detailData.status === 'schedule_service_define_status:2') {
                        this.previewTags = ['check']
                    } else if (detailData.status === 'schedule_service_define_status:3') {
                        this.previewTags = ['effective']
                    } else if (detailData.status === 'schedule_service_define_status:4') {
                    ...
                    this.previewContent.headers = {
                        ...
                        serviceEffectDate: detailData.serviceEffectDate,
                        serviceExpireDate: detailData.serviceExpireDate,
