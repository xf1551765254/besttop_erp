 ...
 * @Company: BestTop
 * @Author: haile
 * @Date: 2019-07-17 09:54:53   ExchangeApplication
 * @LastEditors: laikt
 * @LastEditTime: 2019-08-27 18:38:38
 -->
<template>
...
export default {
    ...
    data () {
        return {
            ...
            menuOpt: [
                {
                    name: '编辑',
                    action: 'ExchangeApplication.edit',
                    fc: this.auditHandler
                },
                {
                    name: '审核',
                    action: 'ExchangeApplication.verify',
                    fc: this.auditCancel
                },
                {
                    name: '删除',
                    action: 'ExchangeApplication.delete',
                    fc: this.deleteHandler
                },
                { name: '预览',
                    action: 'ExchangeApplication.query',
                    fc: this.detailHandler
                },
                { name: '查看物流',
                    action: 'ExchangeApplication.get',
    ...
    mounted () {
        this.$nextTick(() => {
            this.tableCode = '09c57801dd4e4ef1afbb-fe083e1fe0f7:ExchangeApplication'
            this.tableApiPath = 'DistReturnApplyFindByPrimaryKey2ExchangeGoods'
    ...
    methods: {
        ...
        onSeachClick (e) {
            if (e === 'add') {
                ...
                this.$refs.newTable.exportFile('DistReturnApplyFindByPrimaryKey2ExchangeGoods')
            }
        },
        ...
        reLoadTableData () {
            this.$refs.newTable.setTableData(this.tableCode, { path: 'DistReturnApplyFindByPrimaryKey2ExchangeGoods' })
        },
        ...
        handleSubmit () {
            ...
            if (this.returnData.applyDetail.length === 0) {
                ...
                if (this.returnData.applyMain.type === '') {
                    ...
                    if (this.isDelatis === 1) {
                        axios({
                            path: 'DistReturnApplyAddSelective2ExchangeGoods',
                            method: 'post',
                            body: data
                        }).then(res => {
                            if (res.flag === 1) {
