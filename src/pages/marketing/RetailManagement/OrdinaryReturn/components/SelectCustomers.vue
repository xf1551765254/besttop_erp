 ...
 * @LastEditors: laikt
 * @LastEditTime: 2019-08-19 19:14:52
 -->
<template>
        ...
        <div class="list-box">
          ...
          <div v-if="customerInfo.length>0" class="customer">
            <div v-for="(add,index) in customerInfo" :key="index">
              <a-button @click="emitCustomer(add)" style="width:80px;">
                {{ add.name }}
              </a-button>
...
export default {
    ...
    methods: {
        ...
        handleChange (value) {
            ...
            this.customerCode = customer[0].code
            // axios({
        ...
        queryCustomer (id) {
            axios({
                ...
                method: 'POST',
                body: {
                    customerCode: id || this.customerCode
                }
            }).then(res => {
                if (res.flag === 1) {
                    console.log(res.data)
                    ...
                    axios({
                        ...
                        if (res.flag === 1) {
                            ...
                            if (res.data) {
                                ...
                                this.queryCustomer(res.data.code)
