 ...
 * @Company: BestTop
 * @Author: haile
 * @Date: 2019-07-17 09:51:36
 * @LastEditors: laikt
 * @LastEditTime: 2019-08-27 18:38:46
 -->
<template>
  <div class="ordinaryReturn">
    <seachBox
    ...
    <bt-modal
      ...
      <!-- 基础信息 -->
      <Handle :isDelatis="isDelatis" :returnData.sync="returnData" :type="1"></Handle>
      <a-divider dashed/>
      <!-- 添加表格 -->
    </bt-modal>
    <a-modal
...
export default {
    ...
    data () {
        return {
            ...
            menuOpt: [
                {
                    name: '编辑',
                    action: 'OrdinaryReturn.edit',
                    fc: this.auditHandler
                },
                {
                    name: '审核',
                    action: 'OrdinaryReturn.verify',
                    fc: this.auditCancel
                },
                {
                    name: '删除',
                    action: 'OrdinaryReturn.delete',
                    fc: this.deleteHandler
                },
                { name: '预览',
                    action: 'OrdinaryReturn.query',
                    fc: this.detailHandler
                },
                { name: '查看物流',
                    action: 'OrdinaryReturn.get',
    ...
    mounted () {
        this.$nextTick(() => {
            this.tableCode = '384cf35082414c15a3e56ebbc4aee5c3:OrdinaryReturn'
    ...
    methods: {
        ...
        getLogistics (getData) {
            // console.log(returnApplyCode, sourceCode)
            console.log(getData)
            ...
            axios({
                ...
                method: 'post',
                body: {
                    returnApplyCode: getData.code,
                    sourceCode: getData.sourceCode || ''
                }
            }).then(res => {
