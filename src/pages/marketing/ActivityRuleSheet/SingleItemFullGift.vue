 ...
 * @Company: BestTop
 * @Author: lin
 * @Date: 2019-07-18 11:05:30
 * @LastEditors: lin
 * @LastEditTime: 2019-08-28 17:17:26
 -->
<template>
  <div>
    <!-- 工具栏 -->
...
import Preview from '@pages/marketing/ActivityRuleSheet/preview/SingleItemFullGiftPreview'
...
export default {
    ...
    data () {
        return {
            ...
            menuOpt: [
                { name: '编辑',
                    action: 'SingleItemFullGift.edit',
                    fc: this.addEdit
                }, { name: '删除',
                    action: 'SingleItemFullGift.delete',
                    fc: this.deleteHandler
                }, { name: '审核',
                    action: 'SingleItemFullGift.verify',
    ...
    mounted () {
        this.seachValue.scheduleType = 'schedule_rule_define_schedule_type:3'
        this.$nextTick(() => {
            this.tableCode = '84c38186bc09469583adb70a0c87f169:SingleItemFullGift'
    ...
    methods: {
        ...
        addEdit (addEditData) {
            if (addEditData === -1) {
                this.isAdd = true
                this.AddEditModalTitle = '新增单品满赠活动规则单'
                ...
                this.isAdd = false
                this.AddEditModalTitle = '编辑单品满赠活动规则单'
        ...
        handleSubmit (e) {
            ...
            validateFields((err, values) => {
                if (!err) {
                    ...
                    values.scheduleType = 'schedule_rule_define_schedule_type:3'
