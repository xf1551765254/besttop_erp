 ...
 * @Company: BestTop
 * @Author: lin
 * @Date: 2019-07-18 11:04:17
 * @LastEditors: lin
 * @LastEditTime: 2019-08-28 17:18:26
 -->
<template>
  <div>
    <!-- 工具栏 -->
...
import Preview from '@pages/marketing/ActivityRuleSheet/preview/SingleItemFullSubtractPreview'
...
export default {
    ...
    data () {
        return {
            ...
            menuOpt: [
                { name: '编辑',
                    action: 'SingleItemFullSubtract.edit',
                    fc: this.addEdit
                }, { name: '删除',
                    action: 'SingleItemFullSubtract.delete',
                    fc: this.deleteHandler
                }, { name: '审核',
                    action: 'SingleItemFullSubtract.verify',
                    ...
                    action: 'SingleItemFullSubtract.get',
    ...
    mounted () {
        this.seachValue.scheduleType = 'schedule_rule_define_schedule_type:2'
        this.$nextTick(() => {
            this.tableCode = '5aede31a1925430b89f5a179de350051:SingleItemFullSubtract'
    ...
    methods: {
        ...
        addEdit (addEditData) {
            if (addEditData === -1) {
                this.isAdd = true
                this.AddEditModalTitle = '新增单品满减活动规则单'
                ...
                const { mul } = this.$math
                this.isAdd = false
                this.AddEditModalTitle = '编辑单品满减活动规则单'
        ...
        handleSubmit (e) {
            ...
            validateFields((err, values) => {
                if (!err) {
                    ...
                    values.scheduleType = 'schedule_rule_define_schedule_type:2'
