 ...
 * @Company: BestTop
 * @Author: lin
 * @Date: 2019-07-23 11:13:22
 * @LastEditors: lin
 * @LastEditTime: 2019-08-08 18:45:12
 -->
<template>
  <div>
    <Preview
      ...
      <div slot="A" title="返币规则">
        <a-col :sm="8" :md="4" :xl="3">电子币类型</a-col>
        <a-col :sm="16" :md="8" :xl="5">{{ previewForm.scheduleCoinTypeDefineName||'' }}</a-col>
        ...
        <a-col :sm="16" :md="8" :xl="5">{{ previewForm.effectDate||'' }}</a-col>
      </div>
      <div slot="B" title="返币商品详情" :isTable="true" :columns="previewColumns" :data="previewTableData"></div>
      <div slot="footer">
        <a-row>
    ...
    data () {
        return {
            ...
            previewHeaders: [
                ...
                { key: 'ifSingle', name: '与单品同时使用' },
                { key: 'rateClass', name: '达标品类' },
                { key: 'note', name: '备注' }
            ],
            previewColumns: [
            ...
            axios({
                ...
                if (res.flag === 1) {
                    ...
                    this.previewContent.headers = {
                        ...
                        ifSingle: detailData.ifSingle === 1 ? '是' : '否',
                        rateClass: detailData.rateClass,
                    ...
                    this.previewForm = {
                        ...
                        effectDate: detailData.effectDate,
                        scheduleCoinTypeDefineName: detailData.scheduleCoinTypeDefineName
