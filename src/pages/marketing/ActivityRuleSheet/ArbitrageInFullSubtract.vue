 ...
 * @Company: BestTop
 * @Author: lin
 * @Date: 2019-07-18 11:09:48
 * @LastEditors: lin
 * @LastEditTime: 2019-08-28 17:16:11
 -->
<template>
  <div>
    <!-- 工具栏 -->
    ...
    <bt-modal
      ...
      <!-- 满减规则 -->
      <a-form :form="form">
        <a-row class="titleSet" style="">满减规则</a-row>
        <a-row>
...
import Preview from '@pages/marketing/ActivityRuleSheet/preview/ArbitrageInFullSubtractPreview'
...
export default {
    ...
    data () {
        return {
            ...
            seachValue: {
                scheduleType: 'schedule_rule_define_schedule_type:5',
            ...
            menuOpt: [
                { name: '编辑',
                    action: 'ArbitrageInFullSubtract.edit',
                    fc: this.addEdit
                }, { name: '删除',
                    action: 'ArbitrageInFullSubtract.delete',
                    fc: this.deleteHandler
                }, { name: '审核',
                    action: 'ArbitrageInFullSubtract.verify',
                    ...
                    action: 'ArbitrageInFullSubtract.get',
            ...
            tableColumns: [
                ...
                { title: '达标单价', dataIndex: 'reachUnitPrice', align: 'center', width: 120, scopedSlots: { customRender: 'reachUnitPrice' } },
                { title: '备注', dataIndex: 'note', align: 'center', width: 200, scopedSlots: { customRender: 'note' } }
            ],
            detailTableData: [],

            rateProviderOneCB: '0', // 有品牌品类的分摊bilv
    ...
    mounted () {
        this.seachValue.scheduleType = 'schedule_rule_define_schedule_type:5'
        this.$nextTick(() => {
            this.tableCode = '8e5889599f0d4fda8aca02a87d340e7e:ArbitrageInFullSubtract'
    ...
    methods: {
        ...
        addEdit (addEditData) {
            if (addEditData === -1) {
                this.isAdd = true
                this.AddEditModalTitle = '新增套购满减活动规则单'
                ...
                const { mul } = this.$math
                this.isAdd = false
                this.AddEditModalTitle = '编辑套购满减活动规则单'
        ...
        handleSubmit (e) {
            ...
            validateFields((err, values) => {
                if (!err) {
                    ...
                    values.scheduleType = 'schedule_rule_define_schedule_type:5'
