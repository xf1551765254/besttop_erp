 ...
 * @LastEditors: lmt
 * @LastEditTime: 2019-07-24 19:11:02
 -->
<template>
  <preview
    ...
    <div slot="A" title="B账户使用配置详情" :isTable="true" :columns="previewColumns" :data="epreviewTableData"></div>
    <div slot="footer">
      <a-row>
    ...
    data () {
        return {
            ...
            previewColumns: [
                ...
                { title: '品类名称', dataIndex: 'className', width: 180, align: 'center' },
                { title: '品牌编码', dataIndex: 'brandCode', width: 180, align: 'center' },
                { title: '品牌名称', dataIndex: 'brandName', width: 180, align: 'center' },
