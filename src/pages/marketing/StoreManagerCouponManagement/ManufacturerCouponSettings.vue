 ...
 * @Company: BestTop
 * @Author: lin
 * @Date: 2019-07-26 09:31:53
 * @LastEditors: lin
 * @LastEditTime: 2019-08-26 09:27:48
 -->
<template>
  <div>
    <!-- 工具栏 -->
...
import Preview from '@pages/marketing/StoreManagerCouponManagement/preview/ManufacturerCouponSettingsPreview'
export default {
    ...
    data () {
        return {
            ...
            menuOpt: [
                { name: '编辑',
                    action: 'ManufacturerCouponSettings.edit',
                    fc: this.addEdit
                }, { name: '删除',
                    action: 'ManufacturerCouponSettings.delete',
                    fc: this.deleteHandler
                }, { name: '审核',
                    action: 'ManufacturerCouponSettings.verify',
                    fc: this.auditHandler
                },
                { name: '预览',
                    action: 'ManufacturerCouponSettings.get',
    ...
    mounted () {
        this.$nextTick(() => {
            this.tableCode = '55fcc8dfd9d1420998aa72da19708c22:ManufacturerCouponSettings'
    ...
    methods: {
        ...
        addEdit (addEditData) {
            ...
            if (addEditData === -1) {
                this.isAdd = true
                this.addEditModalTitle = '新增厂家券配置'
                ...
                const { mul } = this.$math
                this.isAdd = false
                this.addEditModalTitle = '编辑厂家券配置'
        ...
        handleSubmit (e) {
            ...
            validateFields((err, values) => {
                if (!err) {
                    ...
                    values.type = 'coupon_define_type:1'
    ...
    watch: {
        '$store.state.app.pageName' (to, from) {
            if (to === 'ManufacturerCouponSettings') {
                this.getEffectStoreArr()
            }
        },
