 ...
 * @Company: BestTop
 * @Author: lin
 * @Date: 2019-06-19 17:32:37
 * @LastEditors: lin
 * @LastEditTime: 2019-07-05 17:19:58
 -->
<template>
  <div>
    <!-- 工具栏 -->
    ...
    <bt-modal
      ...
      <a-form :form="form" class="setCol">
        <a-row>
          <a-col :sm="8" :md="4" :xl="3">活动标题</a-col>
          <a-col :sm="16" :md="20" :xl="21">
            <a-form-item>
              <a-input
                placeholder="请输入广告标题"
                v-decorator="$check('ActiveManagement.titles', {initialValue:tableSingleData.titles||''})"/>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row>
          <a-col :sm="8" :md="4" :xl="3">副标题</a-col>
          <a-col :sm="16" :md="20" :xl="21">
            <a-form-item>
              <a-input
                placeholder="请输入副标题"
                v-decorator="$check('ActiveManagement.subtitle', {initialValue:tableSingleData.subtitle||''})"/>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row>
          <a-col :sm="8" :md="4" :xl="3">活动类型</a-col>
          <a-col :sm="16" :md="20" :xl="21" style="height:auto;margin-bottom:0">
            <a-form-item>
              <a-select
                ...
                v-decorator="$check('ActiveManagement.scheduleType',{initialValue:tableSingleData.scheduleType})"
                allowClear/>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row style="">
          ...
          <a-col :sm="16" :md="20" :xl="21" class="setEdit" style="height:auto;margin-bottom:0">
            <a-form-item>
        ...
        <a-row>
          ...
          <a-col :sm="16" :md="8" :xl="5">
            <a-form-item>
              <a-select
                ...
                style="width: 100%"
                :options="statusArr"
                v-decorator="$check('ActiveManagement.status',{initialValue:tableSingleData.status||'marketing_schedule_status:1'})"
                allowClear/>
            </a-form-item>
          </a-col>
          ...
          <a-col :sm="16" :md="8" :xl="5">
            <a-form-item>
              <a-radio-group @change="changeIsRecommend" v-decorator="$check('ActiveManagement.isRecommend', {initialValue:tableSingleData.isRecommend||0})">
          ...
          <a-col :sm="16" :md="8" :xl="5">
            <a-form-item>
              <a-input-number
                ...
                placeholder="请输入排序"
                v-decorator="$check('ActiveManagement.sort', {initialValue:tableSingleData.sort||sort})"
              />
            </a-form-item>
          </a-col>
          ...
          <a-col :sm="16" :md="8" :xl="5">
            <a-form-item>
              <a-radio-group @change="changeTermValidity" v-decorator="$check('ActiveManagement.termValidity', {initialValue:tableSingleData.termValidity||0})">
                <a-radio :value="1">是</a-radio>
                <a-radio :value="0">否</a-radio>
              </a-radio-group>
            </a-form-item>
          ...
          <a-col :sm="16" :md="8" :xl="5">
            <a-form-item>
              <a-date-picker
                ...
                :showTime="{format:'HH'}"
                :showToday="true"
                v-decorator="$check('ActiveManagement.startTime', {initialValue:tableSingleData.startTime})"
                @change="changeData"/>
            </a-form-item>
          </a-col>
          ...
          <a-col :sm="16" :md="8" :xl="5">
            <a-form-item>
              <a-date-picker
                ...
                v-decorator="$check('ActiveManagement.endTime', {initialValue:tableSingleData.endTime})"/>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
    ...
    <a-modal
      ...
      <a-form>
        ...
        <a-row style="margin-top:20px">
          <a-col :sm="8" :md="4" :xl="3">副标题：</a-col>
          <a-col :sm="16" :md="20" :xl="21" style="">
            {{ tableSingleData.subtitle }}
          </a-col>
        </a-row>
        <a-row style="margin-top:20px">
          <a-col :sm="8" :md="4" :xl="3">内容：</a-col>
          <a-col :sm="16" :md="20" :xl="21" style="height:auto;margin-bottom:0">
            <p v-html="tableSingleData.content"></p>
          </a-col>
        </a-row>
        <a-row style="margin-top:20px">
          <a-col :sm="8" :md="4" :xl="3">封面图：</a-col>
...
export default {
    ...
    data () {
        return {
            ...
            menuOpt: [
                { name: '编辑',
                    action: 'ActiveManagement.edit',
                    fc: this.addEdit
                },
                { name: '删除',
                    action: 'ActiveManagement.delete',
                    fc: this.deleteHandler
                },
                { name: '启用',
                    action: 'ActiveManagement.enable',
                    fc: this.enableHandler
                },
                { name: '停用',
                    action: 'ActiveManagement.disable',
                    fc: this.disableHandler
                },
                { name: '预览',
                    action: 'ActiveManagement.get',
    ...
    mounted () {
        this.$nextTick(() => {
            this.tableCode = 'ca5d418f44bd4406a06e5d7ba1295d6d:ActiveManagement'
            this.tableApiPath = 'MarketingScheduleQuerySchedule'
            this.$refs.newTable.setContextmenu(this.menuOpt)
        })
        this.getStatusDorpArr()
        this.getScheduleTypeArr()
    },
    methods: {
        /**
         * @name: // 表格数据搜索
        ...
        onSeach (e) {
            console.log(e)
            e.path = 'MarketingScheduleQuerySchedule'
        ...
        onSeachClick (e) {
            if (e === 'add') {
                ...
                this.$refs.newTable.exportFile('MarketingScheduleQuerySchedule')
            }
        },
        /**
         * @name: 更新表格
         ...
         */
        reLoadTableData () {
            this.$refs.newTable.setTableData(this.tableCode, { path: 'MarketingScheduleQuerySchedule' })
        },
        /**
         * @name: 表格的多选
         * @msg:
        ...
        onContextmenuChange (tableRow) {
            ...
            if (tableRow.status === 'marketing_schedule_status:1') {
        ...
        deleteHandler (delData) {
            ...
            if (delData === -1) {
                ...
                const isDisabled = newData.filter(o => o.status !== 'marketing_schedule_status:2')
            ...
            this.$confirm({
                ...
                onOk () {
                    axios({
                        path: 'MarketingScheduleDelSchedule', // 接口path名，必传
                        method: 'post',
                        body: {
                            ids: arr
                        }
        ...
        enableHandler (enableData) {
            ...
            this.$confirm({
                ...
                onOk () {
                    axios({
                        path: 'MarketingScheduleUpdateStatus', // 接口path名，必传
                        method: 'post',
                        body: {
                            ids: arr,
                            status: 'marketing_schedule_status:1'
                        }
                    }).then(res => {
                        if (res.flag === 1) {
        ...
        disableHandler (disData) {
            ...
            if (disData === -1) {
                ...
                const newData = [...this.tableRowsArr]
                const isEnable = newData.filter(o => o.status !== 'marketing_schedule_status:1')
            ...
            this.$confirm({
                ...
                onOk () {
                    axios({
                        ...
                        body: {
                            ids: arr,
                            status: 'marketing_schedule_status:2'
                        }
                    }).then(res => {
                        if (res.flag === 1) {
                            self.reLoadTableData()
        ...
        submitInfo (e) {
            ...
            validateFields((err, values) => {
                if (!err) {
                    ...
                    axios({
                        path: this.isAdd ? 'MarketingScheduleAddSchedule' : 'MarketingScheduleUpdateSchedule',
                        method: 'post',
                        body: values
                    }).then(res => {
        ...
        getStatusDorpArr () {
            axios({
                ...
                method: 'post',
                body: {
                    type: 'marketing_schedule_status'
                }
            }).then(res => {
                if (res.flag === 1) {
                    console.log(res)
        ...
        getScheduleTypeArr () {
            axios({
                path: 'SystemClassifyQueryChildren',
                method: 'post',
                body: {
                    superCode: '03'
                }
        ...
        getSort () {
            axios({
                path: 'MarketingScheduleQueryMaxSort',
                method: 'post'
            }).then(res => {
                if (res.flag === 1) {
                    this.sort = res.data
