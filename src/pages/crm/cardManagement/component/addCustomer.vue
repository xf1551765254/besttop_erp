 ...
 * @Company: BestTop
 * @Author: lin
 * @Date: 2019-08-22 16:41:31
 * @LastEditors: lin
 * @LastEditTime: 2019-08-23 11:30:42
 -->
<template>
  <div>
    <a-modal
        ...
        <a-row class="doc">
          ...
          <a-col :span="8">
            <a-form-item>
              <a-input
                placeholder="请输入联系电话"
                v-decorator="$check('customer.telephone', {initialValue:'', validateTrigger:'blur'}, queryCustomer)"
              />
            </a-form-item>
          </a-col>
          ...
          <a-col :span="8">
            <a-form-item>
              <a-input
                placeholder="请输入顾客姓名"
                v-decorator="$check('customer.name', {initialValue: ''})"
          ...
          <a-col :span="20">
            <a-form-item>
              <a-radio-group
                v-decorator="$check('customer.sex', {initialValue: 0})"
                :disabled="disableEdit"
              >
          ...
          <a-col :span="20">
            <a-form-item>
              <a-input
                placeholder="请输入详细地址"
                v-decorator="$check('customer.address', {initialValue:''})"
                :disabled="true"
              />
            </a-form-item>
          </a-col>
          ...
          <a-col :span="20">
            <a-form-item>
              <a-input
                placeholder="街道、楼牌号等"
                v-decorator="$check('customer.addressDetail', {initialValue:''})"
                :disabled="disableEdit"
              />
            </a-form-item>
          </a-col>
