 ...
 * @LastEditTime: 2019-04-23 18:15:17
 -->
<template>
  <div>
    <!-- 工具栏 -->
...
export default {
    ...
    mounted () {
        this.$nextTick(() => {
            this.tableCode = '5e96af0bf78f48adbf7bace1aa506aa6:inventoryLossRanking'
            // this.tableApiPath = 'StocktakeStatisticalFindLossRanking'
        })
    },
    data () {
        return {
            tableCode: '',
            tableApiPath: 'StocktakeStatisticalFindLossRanking',
            // 工具栏按钮组
            btns: ['export'],
            // 工具栏表单组
            conditions: [
    ...
    methods: {
        ...
        onClick (e) {
            if (e === 'export') {
                this.$refs.newTable.exportFile('StocktakeStatisticalFindLossRanking', this.seachValue)
            }
        },
        /**
         ...
         */
        onSeach (e) {
            e.path = 'StocktakeStatisticalFindLossRanking'
