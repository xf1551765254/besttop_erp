<!--
 * @Description: 用户选择组件（按店筛选）
 * @Version: ^1.2.0
 * @Company: BestTop
 * @Author: Oak
 * @LastEditors: lmt
 * @Date: 2019-02-21 15:50:19
 * @LastEditTime: 2019-04-24 16:03:33
 -->
<template>
  <div>
    <a-modal
        ...
        <a-row :gutter="20">
          <a-col :span="14">
            ...
            <a-row>
              ...
              <a-col :span="20">
                <a-input placeholder="请输入搜索值" v-model="userCode" @change="seach" />
              </a-col>
            </a-row>
    ...
    data () {
        return {
            ...
            columns: [
                ...
                { title: '邮箱', dataIndex: 'email', width: 250, align: 'center' },
