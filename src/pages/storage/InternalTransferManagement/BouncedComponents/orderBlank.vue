 ...
 * @LastEditTime: 2019-06-12 18:21:14
 -->
<template>
  <div>
    <a-modal
      ...
      <a-spin :spinning="spinning">
        <a-row class="doc">
          <a-col :span="3">配送单号</a-col>
          <a-col :span="8">
            <a-input
              placeholder="请选输入配送单号"
              style="width: 100%"
              @change="skuSeach"
              allowClear/>
          </a-col>
...
export default {
    ...
    data () {
        return {
            ...
            spinning: true,
            columns: [
                { title: '配送单单号', dataIndex: 'code', width: 100 },
                { title: '配送中心', dataIndex: 'sourceStoreCode', width: 100 },
                { title: '收货位置', dataIndex: 'destinationStoreCode', width: 100 },
                { title: '源单据号', dataIndex: 'sourceCode', width: 100 },
                { title: '负责人', dataIndex: 'chargeBy', width: 100 },
                { title: '制单时间', dataIndex: 'createTime', width: 100 },
                { title: '制单人', dataIndex: 'createBy', width: 100 },
                { title: '制单位置', dataIndex: 'makeStoreId', width: 100 },
    ...
    methods: {
        ...
        getData (pams = {}) {
            ...
            const p = Object.assign({
                page: 1,
                rows: 9999,
                billStatus: 'bill_allot_status:2'
            }, newPams)
            axios({
