 ...
 * @LastEditTime: 2019-08-01 13:51:49
 -->
<template>
  <div>
    <!-- 工具栏 -->
    ...
    >
      ...
      <a-form :form="form">
        <a-row class="doc">
          <a-col :sm="8" :md="4" :xl="3">退配分店</a-col>
        ...
        <a-row>
          <a-button class="categoryinfo-btn" @click="goodsAdd(1)">添加退配商品</a-button>
          <a-button class="categoryinfo-btn" @click="goodsAdd(-1)">选择配货单</a-button>
      ...
      <orderBlank :flagObj="flagObj" :visible.sync="enquiryHide" :pams="pamsEnquiry" @onSelect="onSelectEnquiry"/>
    </bt-modal>
...
import orderBlank from '@pages/storage/InternalTransferManagement/BouncedComponents/orderBlank'
import Preview from './preview/StoreReturnPreview'
...
export default {
    ...
    data () {
        return {
            ...
            rightMenu: [
                {
                    name: '编辑',
                    action: 'StoreReturn.edit',
                    fc: this.addData
                },
                {
                    name: '删除',
                    action: 'StoreReturn.delete',
                    fc: this.deleteHandler
                },
                {
                    name: '审核',
                    action: 'StoreReturn.verify',
            ...
            categoryinfoColumns: [
                ...
                { title: '实退数量', dataIndex: 'qtty', width: 150, scopedSlots: { customRender: 'qtty' }, align: 'center' },
                { title: '现库存', dataIndex: 'curNumber', width: 150, align: 'center' },
                { title: '备注', dataIndex: 'note', scopedSlots: { customRender: 'note' } },
                { title: '操作', key: 'operation', fixed: 'right', width: 100, scopedSlots: { customRender: 'action' }, align: 'center' }
            ], // 表头
            categoryinfoData: [], // 表体
            orderId: '',
            tags: [],
    ...
    mounted () {
        this.$nextTick(() => {
            this.tableCode = '0e1aa1a238c140fcbe2b6af07cc082e7:StoreReturn'
            this.tableApiPath = 'DistributionBillAllotFindd'
    ...
    methods: {
        ...
        submitClick (e) {
            ...
            validateFields((err, values) => {
                ...
                if (this.addEdit === 'edit') {
                    ...
                    addArr = Object.assign(addArr, { billType: 'bill_allot_type:4' })
                }
                if (!err) {
        ...
        onSeachClick (e) {
            ...
            if (e === 'add') {
                ...
                this.$refs.newTable.exportFile('DistributionBillAllotFindd', this.seachValue)
            } else if (e === 'print') {
         ...
         */
        onSeach (e) {
            e.path = 'DistributionBillAllotFindd'
