 ...
 * @LastEditTime: 2019-08-01 13:52:50
 -->
<template>
  <div>
    <!-- 工具栏 -->
    ...
    >
      ...
      <a-form :form="form">
        <a-row class="doc">
          <a-col :sm="8" :md="4" :xl="3">调入仓库</a-col>
          ...
          <a-col :sm="8" :md="4" :xl="3">调出仓库</a-col>
          <a-col :sm="16" :md="8" :xl="5">
            <a-form-item>
...
import Preview from './preview/WarehousTransferPreview'
...
export default {
    ...
    data () {
        return {
            ...
            rightMenu: [
                {
                    name: '编辑',
                    action: 'WarehousTransfer.edit',
                    fc: this.addData
                },
                {
                    name: '删除',
                    action: 'WarehousTransfer.delete',
                    fc: this.deleteHandler
                },
                {
                    name: '审核',
                    action: 'WarehousTransfer.verify',
    ...
    mounted () {
        this.$nextTick(() => {
            this.tableCode = 'f5220c757cf94084ab0c88a6b295d834:WarehousTransfer'
            this.tableApiPath = 'DistributionBillAllotFinda'
    ...
    methods: {
        ...
        onSeachClick (e) {
            ...
            if (e === 'add') {
                ...
                this.$refs.newTable.exportFile('DistributionBillAllotFinda', this.seachValue)
            } else if (e === 'print') {
         ...
         */
        onSeach (e) {
            e.path = 'DistributionBillAllotFinda'
