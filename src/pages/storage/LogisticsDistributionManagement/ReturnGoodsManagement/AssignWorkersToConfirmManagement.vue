 ...
 * @LastEditors: Reat
 * @LastEditTime: 2019-08-27 16:10:59
 -->
<!-- 派工确认管理 -->
<template>
  <div class="mine">
...
export default {
    ...
    data () {
        return {
            ...
            MenuOperations: [
                {
                    name: '派工确认',
                    action: 'AssignWorkersToConfirmManagement.add',
                ...
                {
                    name: '预览',
                    action: 'AssignWorkersToConfirmManagement.get',
                    fc: row => {
    ...
    mounted () {
        ...
        this.$nextTick(() => {
            ...
            this.tableApiPath = 'DistributionReturnsFindRetreatConfirm'
        })
        this.getAll()
    ...
    methods: {
        ...
        getTypeStatistics () {
            ...
            axios({
                path: 'DistributionReturnsFindRetreatConfirm',
                method: 'post',
                body: obj
            }).then(res => {
                if (res.flag === 1) {
        ...
        onSeach (e = {}) {
            this.seachValue.path = 'DistributionReturnsFindRetreatConfirm'
        ...
        onSeachClick (e) {
            if (e === 'add') {
                ...
                this.$refs.newTable.exportFile('DistributionReturnsFindRetreatConfirm', this.seachValue)
                // console.log('导出')
            } else if (e === 'print') {
                // console.log('打印')
            }
        ...
        getDate () {
            this.$refs.newTable.setTableData('9323ead611ec471182310c8957692c74:AssignWorkersToConfirmManagement', { path: 'DistributionReturnsFindRetreatConfirm' })
        },
