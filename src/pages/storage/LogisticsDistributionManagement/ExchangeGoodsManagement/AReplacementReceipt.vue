 ...
 * @LastEditors: Reat
 * @LastEditTime: 2019-08-27 15:49:25
 -->
<!-- 确认签收 -->
<template>
  <div class="mine">
    ...
    <seachBox
      ...
      @onReload="onReload"
      @onSeach="onSeach">
      <a-button v-action:add type="primary" size="small" @click="onConfirmSignature(-1)">确认签收</a-button>
    </seachBox>
    <!-- 表格 -->
    <NewTable
      ref="newTable"
...
export default {
    ...
    data () {
        return {
            ...
            MenuOperations: [
                {
                    name: '确认签收',
                    action: 'AReplacementReceipt.add',
                    fc: this.onConfirmSignature
                },
                {
                    name: '预览',
                    action: 'AReplacementReceipt.get',
                    fc: row => {
    ...
    mounted () {
        ...
        this.$nextTick(() => {
            ...
            this.tableCode = '7bdedb8bf0834302a395c1fba923f0e5:AReplacementReceipt'
            this.tableApiPath = 'DistributionReturnsFindChangeSignfor'
        })
        this.getAll()
    ...
    methods: {
        ...
        getTypeStatistics () {
            ...
            axios({
                path: 'DistributionReturnsFindChangeSignfor',
                method: 'post',
                body: obj
            }).then(res => {
                if (res.flag === 1) {
        ...
        onSeach (e = {}) {
            this.seachValue.path = 'DistributionReturnsFindChangeSignfor'
        ...
        onSeachClick (e) {
            if (e === 'add') {
                ...
                this.$refs.newTable.exportFile('DistributionReturnsFindChangeSignfor', this.seachValue)
                // console.log('导出')
            } else if (e === 'print') {
                // console.log('打印')
            }
        ...
        getDate () {
            this.$refs.newTable.setTableData('7bdedb8bf0834302a395c1fba923f0e5:AReplacementReceipt', { path: 'DistributionReturnsFindChangeSignfor' })
        }
    }
}
</script>
