 ...
 * @LastEditors: Reat
 * @LastEditTime: 2019-08-27 16:57:11
 -->
<!-- 派工管理 -->
<template>
  <div class="mine">
    ...
    <a-modal
      ...
      class="doc"
      destroyOnClose
      :bodyStyle="{height:'584px',width:'1200px'}"
      centered>
      <h4>派工信息</h4>
      <a-row class="doc">
...
export default {
    ...
    data () {
        return {
            ...
            btns: ['export', 'print'],
            seachValue: {},
            tableCode: '89261a0e70df446a8414ab1f8a851fe8:ExchangeDispatching',
            tableApiPath: '',
            MenuOperations: [
                {
                    name: '派工',
                    action: 'ExchangeDispatching.add',
                    fc: this.onDispatch
                },
                {
                    name: '取消派工',
                ...
                {
                    name: '预览',
                    action: 'ExchangeDispatching.get',
                    fc: row => {
    ...
    methods: {
        ...
        onSeach (e = {}) {
            // this.seachValue.path = 'DistributionReturnsFindChangeDispatching'
            ...
            axios({
                path: 'DistributionReturnsFindChangeDispatching',
                method: 'post',
                body: obj
            }).then(res => {
                if (res.flag === 1) {
                    ...
                    // this.$refs.newTable.setTableColumns(this.tableCode)
                    this.$refs.newTable.setTableData(data.list, { path: 'DistributionReturnsFindChangeDispatching' })
                }
            })
        },
        /**
        ...
        onSeachClick (e) {
            if (e === 'add') {
                ...
                this.$refs.newTable.exportFile('DistributionReturnsFindChangeDispatching', this.seachValue)
                // console.log('导出')
            } else if (e === 'print') {
                // console.log('打印')
            }
