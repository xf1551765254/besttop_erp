 ...
 * @LastEditTime: 2019-08-26 16:57:23
 -->
<template>
  <div>
    <a-modal
...
export default {
    ...
    data () {
        return {
            ...
            columns: [
                ...
                { title: '现库存', dataIndex: 'curNumber', width: 60, align: 'right' }
            ],
            dataSource: [],
            skuSeachId: '',
            brandSeachId: '',
    ...
    methods: {
        ...
        getData (pams = {}) {
            ...
            axios({
                path: 'DistributionSkuStockFindskuDistribubte',
                method: 'POST',
                body: p
            }).then(res => {
                this.spinning = false
                if (res.flag === 1) {
                    ...
                    console.log(this.pagination, '6666666')
                }
            })
        }
    },
