 ...
 * @LastEditTime: 2019-08-23 17:51:03
 -->
<template>
  <div>
    <h4 class="baseInfo">常规机政策价</h4>
    <a-row>
    ...
    <a-table
      ...
      :scroll="scrollXY"
    >
      <template v-for="col in ['strategyPrice','strategyNum','note']" :slot="col" slot-scope="text, record">
        <div :key="col">
          <a-input-number
    ...
    data () {
        return {
            ...
            categoryinfoColumns: [ // 表头
                ...
                { title: '起提数量', dataIndex: 'strategyNum', width: 100, scopedSlots: { customRender: 'strategyNum' } },
