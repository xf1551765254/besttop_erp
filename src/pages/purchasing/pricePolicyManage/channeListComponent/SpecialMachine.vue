 ...
 * @LastEditTime: 2019-08-23 17:57:02
 -->
<template>
  <div>
    <h4 class="baseInfo">特价机</h4>
    <a-row>
    ...
    <!-- <goodsAdd
      :visible.sync="goodsQuery"
      :pams="pams"
      @onSelect="onSelect"
      multiple
      :goodsFlag="goodsSpecialOffer"/> -->
...
<script>
// import goodsAdd from '@pages/purchasing/pricePolicyManage/toop/goodsAdd'
