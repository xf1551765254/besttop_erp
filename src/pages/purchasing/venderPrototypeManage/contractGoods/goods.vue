 ...
 * @LastEditTime: 2019-08-26 16:52:52
 -->
<template>
  <div>
    <a-modal
...
export default {
    ...
    data () {
        return {
            ...
            columns: [
                ...
                { title: '品牌编码', dataIndex: 'brandCode', width: 150 },
    ...
    methods: {
        ...
        getData (pams = {}) {
            ...
            axios({
                path: 'SampleSampleExitFindExitSkuByProvider',
                method: 'POST',
                body: p
            }).then(res => {
                this.spinning = false
                if (res.flag === 1) {
                    console.log(res.data.list, '商品')
