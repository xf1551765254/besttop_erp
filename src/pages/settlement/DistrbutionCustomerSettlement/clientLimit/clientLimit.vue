 ...
 * @LastEditTime: 2019-07-11 18:13:01
 -->
<template>
  <div>
    <a-modal
      ...
      <a-spin :spinning="spinning">
        <a-row :gutter="20">
          <a-col :span="14">
            <a-row>
              <a-col :span="24">
                <a-input addonBefore="编码/名称" placeholder="请输入搜索值" @pressEnter="seach" />
              </a-col>
            </a-row>
    ...
    data () {
        return {
            ...
            columns: [
                ...
                { title: '联系人', dataIndex: 'person', width: 150, align: 'center' },
                { title: '联系电话', dataIndex: 'tele', width: 100, align: 'center' },
                { title: '地址', dataIndex: 'address', width: 250, align: 'center' },
