 ...
 * @LastEditTime: 2019-04-14 20:53:06
 -->
<template>
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div style="height: 20px;">
            <a-tooltip class="setting-drawer-theme-color-colorBlock" v-for="(item, index) in colorList" :key="index">
              ...
              <a-tag :color="item.color" @click="changeColor(item.color)" style="margin-bottom:10px;">
            ...
            <a-list :split="false">
              <a-list-item>
                <a-tooltip slot="actions">
                  ...
                  <a-select size="small" style="width: 80px;" :defaultValue="contentWidth" @change="handleContentWidthChange" disabled>
...
export default {
    ...
    methods: {
        ...mapActions(['setThemeSetting']),
        ...mapGetters(['themeSetting']),
        showDrawer () {
            this.setThemeSetting(true)
        },
        onClose () {
